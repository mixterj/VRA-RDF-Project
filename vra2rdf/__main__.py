...
import sys, getopt, re, rdflib, pprint
...
def parameters():
   ...
   parser.add_option("-s", dest="serialization", help="The serialization for the RDF output. n3 = Turtle, nt = N-Triples, xml = RDF/XML, json-ld = JSON-ld.", action='store')
